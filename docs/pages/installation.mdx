...
### Installing Teleport with package managers
...
https://apt.releases.teleport.dev/${ID?} ${VERSION_CODENAME?} ${TELEPORT_CHANNEL?}/v(=teleport.major_version=)" \
...
$ sudo yum-config-manager --add-repo "$(rpm --eval "https://yum.releases.teleport.dev/$ID/$VERSION_ID/Teleport/%{_arch}/${TELEPORT_CHANNEL?}/v(=teleport.major_version=)/teleport.repo")"
...
$ sudo dnf config-manager --add-repo "$(rpm --eval "https://yum.releases.teleport.dev/$ID/$VERSION_ID/Teleport/%{_arch}/${TELEPORT_CHANNEL?}/v(=teleport.major_version=)/teleport.repo")"
...
### Installing Teleport from the TAR archive
